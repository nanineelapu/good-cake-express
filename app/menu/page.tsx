...
export default function MenuPage() {
  ...
  const categories = [
    { id: 'Cakes', label: 'Cakes', sub: 'Masterpiece' },
    { id: 'Snacks', label: 'Snacks', sub: 'Savory Art' },
    { id: 'Beverages', label: 'Brew', sub: 'Fine Liquid' },
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-white text-text relative w-full">

      {/* ARCHITECTURAL SIDEBAR: FIXED Z-INDEX CLUSTER */}
      <aside className="w-[30%] lg:w-1/4 fixed top-0 left-0 h-screen bg-white border-r border-black/5 z-40 flex flex-col shadow-[10px_0_30px_rgba(0,0,0,0.02)] pt-[82px]">
        {/* Subtle Fine Texture */}
      ...
      <main className="ml-[30%] lg:ml-1/4 relative px-4 md:px-12 lg:px-20 pb-20 pt-[100px] lg:pt-32 min-h-screen grow z-10 bg-white">
        ...
        <div className="flex flex-col gap-2 mb-8 md:mb-16">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-[8px] md:text-[10px] font-mono font-black text-primary uppercase tracking-[0.4em]">The Choice Selection</span>
          </div>
      ...
      {/* FOOTER BLOCKER FIX: High Z-Index on the sibling to cover the fixed sidebar at the bottom */}
      <style jsx global>{`
        footer {
